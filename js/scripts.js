                ...
                <img src="${
                  phones.image
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="text-center">Brand: <span class="phone-brand">${
                          phones.brand
                        }</span></h6>
                        ...
                        <hr/>
                        <p class="text-center features-p">Chipset: <span class="normal-text">${
                          phones.mainFeatures.chipSet
                        }</span></p>

                        <p class="text-center features-p">Display: <span class="normal-text">${
                          phones.mainFeatures.displaySize
                        }</span></p>

                        <p class="text-center features-p">Memory: <span class="normal-text">${
                          phones.mainFeatures.memory
                        }</span></p>

                        <p class="text-center features-p">Storage: <span class="normal-text">${
